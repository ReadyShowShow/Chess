...
import com.jameschen.game.util.PositionValueHelp;
...
public class Position {
    ...
    public static final byte[] IN_BOARD = PositionValueHelp.IN_BOARD;
    public static final byte[] IN_FORT = PositionValueHelp.IN_FORT;
    public static final byte[] LEGAL_SPAN = PositionValueHelp.LEGAL_SPAN;

    public static final byte[] KNIGHT_PIN = PositionValueHelp.KNIGHT_PIN;
    ...
    public static final short[][] PIECE_VALUE = PositionValueHelp.PIECE_VALUE;

    public static final String[] STARTUP_FEN = PositionValueHelp.STARTUP_FEN;
    ...
    public static void readBookData(Context context) {
        ...
        InputStream in = null;
        try {
            in = context.getAssets().open("BOOK.DAT");
